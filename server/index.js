...
[ // Countdown to LHL Lecture
  {time: 75, statement: 'Verify Scheduled Lecture'},
  {time: 70, statement: 'Publish Lecture Preamble'},
  {time: 65, statement: 'Prepare Code'},
  {time: 60, statement: 'Open Code in Multiple Vee-Ess Code Windows'},
  {time: 55, statement: 'Create and Join Zoom Meeting'},
  {time: 50, statement: 'Share Desktop'},
  {time: 45, statement: 'Enable Automatic Transcripts'},
  {time: 40, statement: 'Turn Focus Mode On'},
  {time: 35, statement: 'Open and Arrange Zoom Windows'},
  {time: 30, statement: 'Share Zoom Link with Cohort on Discord lecture links channel for the appropriate cohort'},
